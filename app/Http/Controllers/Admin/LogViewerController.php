...
class LogViewerController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = trans('log_viewer.log_viewer');
        return view('admin.log_viewer.dashboard', compact('chartData', 'percents','title'));
    }
    ...
    public function listLogs(Request $request)
    {
        ...
        return view('admin.log_viewer.logs', compact('headers', 'rows', 'footer','title'));
    }
    ...
    public function show($date)
    {
        ...
        return view('admin.log_viewer.show', compact('log', 'levels', 'level', 'search', 'entries','title'));
    }
...
//            return redirect()->route($this->showRoute, [$date]);
    ...
    public function search($date, $level = 'all', Request $request) {
        ...
        if (is_null($query = $request->get('query')))
            return redirect('admin/log_viewer/logs/'.$date);
        ...
        return view('admin.log_viewer.show', compact('log', 'levels', 'level', 'query', 'entries','title'));
    }
