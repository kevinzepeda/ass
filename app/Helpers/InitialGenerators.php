...
class InitialGenerators
{
    ...
    public function generateData()
    {
        ...
        config(['settings.date_format' => $settings['date_format'] ?? 'F j,Y']);
        config(['settings.date_time_format' => $settings['date_time_format'] ?? 'F j,Y H:i']);
        ...
        if (!$this->userRepository->inRole('admin') && $organization) {
            ...
            config(['settings.date_format' => $organizationSettings['date_format'] ?? 'F j,Y']);
            config(['settings.time_format' => $organizationSettings['time_format'] ?? 'H:i']);
            config(['settings.date_time_format' => $organizationSettings['date_time_format'] ?? 'F j,Y H:i']);
