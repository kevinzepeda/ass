...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(\App\Repositories\BlogCategoryRepository::class, \App\Repositories\BlogCategoryRepositoryEloquent::class);
        $this->app->bind(\App\Repositories\BlogRepository::class, \App\Repositories\BlogRepositoryEloquent::class);
        $this->app->bind(\App\Repositories\BlogCommentRepository::class, \App\Repositories\BlogCommentRepositoryEloquent::class);
        //:end-bindings:
    }
}
